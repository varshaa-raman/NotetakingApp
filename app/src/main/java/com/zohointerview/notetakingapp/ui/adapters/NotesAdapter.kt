...
class NotesAdapter(private val onClickListener: OnClickListener, private val onLongClickListener: OnLongClickListener) : ListAdapter<DomainNote,
        NotesAdapter.NoteViewHolder>(NoteDiffUtilCallBack) {
    ...
    companion object NoteDiffUtilCallBack : DiffUtil.ItemCallback<DomainNote>() {
